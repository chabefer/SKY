...
+ [Treatment Effects:](TE.html) our causal parameters of interest.
+ [The Fundamental Problem of Causal Inference:](FPCI.html) the Treatment Effects of interest can NEVER be observed, even with a sample of infinite size (a very acute problem indeed!). 
...
+ [The Biases of Intuitive Comparisons:](intuit.html) the intuitive comparisons that we use for causal inference (the before/after and with/without comparisons) are generally biased because of factors that determine both the outcomes of the program and who receives it. 
These factors are called confounding factors.
+ [The Fundamental Problem of Statistical Inference:](FPSI.html) in practice, sample sizes are finite. 
...
+ [The perils of significance testing:](perils.html) specification search and publication bias. 
