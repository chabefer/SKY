...
You will not believe this, but sending your chnges to GitHub repository only requires to click on one button.
Yes, only one.
...
When you are happy with what you have done and do not see how to improve it further, you can notify SKY of your changes and ask for them to be included into the actual website.
...
Click on the ``New Pull Request`` button and follow the instructions tht you are given.
If you are uncertain of what to do, look [here](https://git-scm.com/book/en/v2/GitHub-Contributing-to-a-Project).
Once you have submitted your pull request, I will examine it, we might have some back and forth and then, If everything is OK, I'll accept the pull request.
